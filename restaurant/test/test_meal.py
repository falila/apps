...
class PrivateIngredientsAPITests(TestCase):
    ...
    def test_retrieve_meal_list(self):
    ...
    def test_meal_limited_to_restaurant(self):
        """Test that only meals for  restaurant"""
        data = {
            'name': 'pizza',
            'short_description': 'pizza'
        }

        res = self.client.post(MEALS_URL, data)
        self.assertEqual(res.status_code, status.HTTP_201_CREATED)
        # TODO
        #res1 = self.client.get(MEALS_URL, {'restaurant_id': 1})
