...
from main.views import CustomAuthToken as custo_auth
...
urlpatterns = [
    ...
    url(r'^api/restaurant/sign-in/$', rest_auth_views.obtain_auth_token, name='restaurant-sign-in'),
    url(r'^api/restaurant/sign-out', views_restau.logout, {'next_page': '/'}, name='restaurant-sign-out'),
    # url(r'^restaurant/sign-up', views_restau.restaurant_sign_up, name='restaurant-sign-up'),
    url(r'^api/restaurants/$', views_restau.restaurant_home, name='restaurant-home'),
    url(r'^api/restaurants/account/$', views_restau.restaurant_account, name='restaurant-account'),
    url(r'^api/restaurants/(?P<restaurant_id>\d+)/meals/$', views_restau.restaurant_meal, name='restaurant-meal'),
    url(r'^api/restaurants/meals/add/$', views_restau.restaurant_add_meal, name='restaurant-add-meal'),
    url(r'^api/restaurants/(?P<restaurant_id>\d+)/meals/edit/(?P<meal_id>\d+)/$', views_restau.restaurant_edit_meal,
    name='restaurant-edit-meal'),
    url(r'^api/restaurants/order/$', views_restau.restaurant_order, name='restaurant-order'),
    url(r'^api/restaurants/customer/(?P<restaurant_id>\d+)/$', views_restau.restaurant_customer,
